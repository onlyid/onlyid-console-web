...
class AddOrEdit extends PureComponent {
  ...
  checkUserOnBlur = (type) => {
    ...
    form.validateFields([type], async (errors, values) => {
      ...
      const user = await http.get('users/by-mobile-or-email/', { params: { mobileOrEmail: values[type] } })
      ...
      <>
        ...
        >
          ...
          <Descriptions column={1}>
            ...
            <Item label="性别">{user2Add.gender ? GENDER_TEXT[user2Add.gender] : '-'}</Item>
